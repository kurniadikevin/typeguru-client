...
export default function ProfilePage (){
    ...
    return(
        <div className='h-full flex flex-col items-center justify-center gap-5'>
            <Dashboard/>
            <div className='font-bold pt-4 text-xl'>Personal Best</div>
            ...
            <div className="flex gap-8 bg-[color:var(--tertiaryColor)] py-8 px-12 rounded-xl">
                <div className="flex flex-col gap-4 pb-4 ">
                    <div className="font-bold text-[color:var(--accent)]">All</div>
                    <div className="text-2xl">{getUserHighestWpm()}</div>
                </div>
                <div  className="flex flex-col gap-4 pb-4">
                    <div className="font-bold text-[color:var(--accent)]">15s</div>
                    <div className="text-2xl">{getWpmForSpecificType('15')}</div>
                </div>
                <div className="flex flex-col gap-4 pb-4">
                    <div className="font-bold text-[color:var(--accent)]">30s</div>
                    <div className="text-2xl">{getWpmForSpecificType('30')}</div>
                </div> 
                <div className="flex flex-col gap-4 pb-4">
                    <div className="font-bold text-[color:var(--accent)]">60s</div>
                    <div className="text-2xl">{getWpmForSpecificType('60')}</div>
                </div>
            </div>
            <div className="flex gap-8 bg-[color:var(--tertiaryColor)]  py-8 px-12 rounded-xl">
                <div className="flex flex-col gap-4 pb-4">
                    <div className="font-bold text-[color:var(--accent)]">Short</div>
                    <div className="text-2xl">{getWpmForSpecificType('short')}</div>
                </div>
                <div className="flex flex-col gap-4 pb-4">
                    <div className="font-bold text-[color:var(--accent)]">Medium</div>
                    <div className="text-2xl">{getWpmForSpecificType('medium')}</div>
                </div>
                <div className="flex flex-col gap-4 pb-4">
                    <div className="font-bold text-[color:var(--accent)]">Long</div>
